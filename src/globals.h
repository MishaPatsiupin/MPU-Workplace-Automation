...
extern int
    moisture1_air;  // Значение влажности воздуха для первого датчика
extern int
    moisture1_water;  // Значение влажности воды для первого датчика
// #define CS_2 35 // Пин для второго датчика влажности почвы
//  Переменные калибровки для второго датчика влажности почвы
extern int
    moisture2_air;  // Значение влажности воздуха для второго датчика
extern int
    moisture2_water;  // Значение влажности воды для второго датчика

// Датчики наличия жидкости
// #define LIQUID_SENSOR_PLANT 26 // Пин для датчика наличия жидкости в
// растении
...
extern unsigned long
    last_pump_control_time;  // Время последнего управления помпой

// Переменные для работы с окном
// extern bool window_flag; // Флаг состояния окна
// extern unsigned long last_window_control_time; // Время последнего
// управления окном
