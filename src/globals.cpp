...
LiquidCrystal_I2C lcd(MY_LCD2004_ADDRESS, 20,
                      4);  // Устройство для работы с дисплеем
EncButton eb(MY_SW, MY_DT,
             MY_CLK);  // Устройство для работы с энкодером
...
unsigned long last_pump_control_time =
    0;  // Время последнего управления помпой

// Символы облочности, солнечной погоды, градус
byte custom_wind[] = {B11100, B00011, B11000, B00111,
                      B00000, B11100, B00011, B11000};  // Символ ветра
byte custom_sun[] = {B00000, B10001, B01010, B11011,
                     B00100, B11011, B01010, B10001};  // Символ солнца
byte grad[] = {B10000, B00110, B01000, B01000,
               B01000, B00110, B00000, B00000};  // Символ градуса

// Контрольные переменные для работы с датчиками влажности почвы
int moisture1_air = 3016;    // Значение с датчика в воздухе датчика 1
int moisture1_water = 1198;  // Значение с датчика в воде датчика 1
